...
class AlipayNotificationTest < Test::Unit::TestCase
  ...
  def test_acknowledgement
    ...
    #puts fixtures(:'alipay-sgcb').inspect
    begin
      @alipay2 = Alipay.notification(http_raw_data_sgcb, key: fixtures(:'alipay-sgcb')[:key])
      assert Alipay.notification(http_raw_data_sgcb, key: fixtures(:'alipay-sgcb')[:key]).acknowledge
...
END_POST
  ...
  def http_raw_data_sgcb
    'discount=0.00&payment_type=1&subject=%E8%AE%A2%E5%8D%95%E7%BC%96%E5%8F%B7%3AR190151879&trade_no=2014111363338388&buyer_email=18611543280&gmt_create=2014-11-13+20%3A20%3A20&notify_type=trade_status_sync&quantity=1&out_trade_no=R190151879&seller_id=2088611493982911&notify_time=2014-11-13+20%3A39%3A50&body=%5B%22KOSE%E9%AB%98%E4%B8%9D%E9%9B%AA%E8%82%8C%E7%B2%BE%E6%B4%97%E9%A2%9C%E4%B9%B3%22%5D&trade_status=TRADE_SUCCESS&is_total_fee_adjust=N&total_fee=2.75&gmt_payment=2014-11-13+20%3A39%3A50&seller_email=acct-ali%40shiguangcaibei.com&price=2.75&buyer_id=2088902582208882&notify_id=8dcba9445cbd795e3e8f9cc23c057eae6w&use_coupon=N&sign_type=MD5&sign=0596979baa7d4105bd8662048f6c62bd'
  end
end
