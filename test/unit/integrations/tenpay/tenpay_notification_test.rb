...
class TenpayNotificationTest < Test::Unit::TestCase
  ...
  def http_return_request
    'http://test.shiguangcaibei.com/tenpay_checkout/done?bank_type=BL&discount=0&fee_type=1&input_charset=utf-8&notify_id=Uvw12OtEhcWJOWrI_h5vddwwlJcJ2HgiLo7E88Rnsvt9FFfaFT3u5xV9ljcC9l_g0ur0ecJY3Ynru9aMFcGAfED4RMq9vxc5&out_trade_no=R710881279_XWE4TKU6&partner=1223440201&product_fee=275&sign_type=MD5&time_end=20141117154007&total_fee=275&trade_mode=1&trade_state=0&transaction_id=1223440201201411170032328302&transport_fee=0&sign=D9B2F2E05A06505642367B8D7C05F0D8'
  end
